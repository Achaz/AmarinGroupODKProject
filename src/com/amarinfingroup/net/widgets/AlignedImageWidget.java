...
package com.amarinfingroup.net.widgets;
...
public class AlignedImageWidget extends QuestionWidget implements IBinaryWidget {
    private static final String ODK_CAMERA_TAKE_PICTURE_INTENT_COMPONENT = "com.amarinfingroup.net.camera.TakePicture";

	private static final String ODK_CAMERA_INTENT_PACKAGE = "com.amarinfingroup.net.camera";
